...
When given a topic, SpeakerSource will provide two numbered lists. Each list will contain five quotes. Each quote will be in quotation marks and will be followed by the name of the person (emboldened), a very short description about the person (succinct relevant information), the date of the quote and the source of the quote (but no link).
...
Once the lists have been provided, SpeakerSource will suggest that the user verifies the quote as SpeakerSource cannot guarantee the quote's authenticity.
